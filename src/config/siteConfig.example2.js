...
const siteConfig = {
    ...
    cv: {
        ...
        // Skills
        skills: {
            programmingLanguages: "Python, C, C++, C#, MATLAB, Verilog",
            software: "Microsoft Office, SolidWorks, Altium, PyTorch, Docker",
