...
export default function Biography({showAbout = false}) {
    return (
        <div className="max-w-5xl mx-auto prose text-(--foreground)">
            ...
            <br />
            <br />
            I am a PhD graduate from MIT&apos;s <ExtLink href="https://aeroastro.mit.edu/starlab/" target="_blank">Space Telecommunications, Astronomy and Radiation Laboratory</ExtLink> with PI Prof. Kerri Cahoy. I work on space robotics, autonomous systems, instrumentation, and machine learning applied to spacecraft. My PhD was on dynamic tasking formulations for Earth-observing satellites funded by <ExtLink href="https://www.planet.com/" target="_blank">Planet Labs</ExtLink> so we can use existing satellites more effectively through improved perception, onboard planning, and edge computing. My research specifically focuses on safe and verifiable autonomy formulations that can be operationalized in space. I have also conducted research on reinforcement learning for electromagnetic formation flying spacecraft, vision models for remote sensing, and utilizing liquid lenses for laser communications. 
            <br />
            <br />
